...
public class CatalogStreamTest {
   ...
   */
  //This is a sample test. Use this to build your other methods
  @Test
  ...
  public void testPriceLessThanSortMusicCategory() {
    List<MusicItem> items = allMusicItems
        ...
        .sorted(Comparator.comparing(MusicItem::getMusicCategory)) //Comparator is comparing the MusicItem ClassName to the methodName
        .collect(Collectors.toList());
    System.out.println(items);
  }
  ...
  public void testPriceGreaterThanSortPriceDescThenMusicCategory() {
    List<MusicItem> items = allMusicItems
        ...
        .sorted(Comparator.comparing(MusicItem::getPrice).reversed().thenComparing(MusicItem::getArtist))  //Part II page 239
        .collect(Collectors.toList());
    System.out.println(items);
  }
